...
A previous version of this PEP proposed to reuse the existing [metadata standard](https://packaging.python.org/en/latest/specifications/declaring-project-metadata/) that is used to describe projects.
